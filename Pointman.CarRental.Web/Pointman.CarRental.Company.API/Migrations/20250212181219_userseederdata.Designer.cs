...
namespace Pointman.CarRental.Company.API.Migrations
{
    ...
    [Migration("20250212181219_userseederdata")]
    partial class userseederdata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pointman.CarRental.Company.API.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserUserRoles", b =>
                {
                    b.HasOne("Pointman.CarRental.Company.API.Entities.User", null)
                        .WithMany()
